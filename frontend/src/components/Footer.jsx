      ...
      <div className="container mx-auto px-4">
        ...
        <div className="border-t mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <Link to="/" className="font-bold text-xl">ProjectHub</Link>
            <p className="text-sm text-muted-foreground mt-1">© {new Date().getFullYear()} ProjectHub. All rights reserved.</p>
          </div>
